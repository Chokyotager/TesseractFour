...
scoreboard players remove @r[tag=T4_P_ceu,r=10,type=armor_stand,score_T4_P_energy_min=20,c=1,score_T4_P_eoy_min=1,score_T4_P_eoy=2,score_T4_P_eoy_min=1] T4_P_energy 20
