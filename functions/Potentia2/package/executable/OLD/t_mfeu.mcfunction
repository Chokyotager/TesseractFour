...
scoreboard players tag @r[type=armor_stand,tag=T4_P_mfeu_rtt,rm=1,c=1,r=51,score_T4_P_eoy_min=2,score_T4_P_eoy=3] add T4_P_mfeu_t

scoreboard players operation @e[tag=T4_P_mfeu_t,type=armor_stand] T4_P_energy += @s T4_P_ce1
#scoreboard players operation @e[tag=T4_P_mfeu_t,type=armor_stand] T4_P_energy += @s T4_P_ce2
