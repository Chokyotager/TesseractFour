...
execute @e[name=ChunkCheck,type=armor_stand,score_dyn_spawn_min=1,score_dyn_gen_min=1,score_dyn_gen=1,score_dyng_checkvar_min=2] ~ ~ ~ detect ~ 0 ~ cobblestone 0 execute @s ~ ~ ~ detect ~ 25 ~ iron_ore 0 summon armor_stand ~ 95 ~ {CustomName:"choco_genDruidReece",Invisible:1,Invulnerable:1,Tags:["dyno_trigger_a"]}
execute @e[name=choco_genDruidReece,type=armor_stand] ~ ~ ~ fill ~1 64 ~1 ~-1 100 ~-1 air 0 replace leaves
execute @e[name=choco_genDruidReece,type=armor_stand] ~ ~ ~ fill ~1 64 ~1 ~-1 100 ~-1 air 0 replace leaves2
execute @e[name=choco_genDruidReece,type=armor_stand] ~ ~ ~ fill ~1 64 ~1 ~-1 100 ~-1 air 0 replace log
execute @e[name=choco_genDruidReece,type=armor_stand] ~ ~ ~ fill ~1 64 ~1 ~-1 100 ~-1 air 0 replace log2
scoreboard players set @e[name=choco_genDruidReece,type=armor_stand] dyng_onGround 1 {OnGround:1b}
entitydata @e[name=choco_genDruidReece,type=armor_stand,score_dyng_onGround_min=1] {CustomName:"choco_genDruid",NoGravity:1,Tags:["dyno_trigger_a","dyno_spx"]}
...
execute @e[name=ChunkCheck,type=armor_stand,score_dyn_spawn_min=1,score_dyn_gen_min=1,score_dyn_gen=1] ~ ~ ~ detect ~ 0 ~ cobblestone 0 execute @s ~ ~ ~ detect ~ 75 ~ packed_ice 0 summon armor_stand ~ 90 ~ {CustomName:"choco_genIceTowerReece",Invisible:1,Invulnerable:1,Tags:["dyno_trigger_a"]}
execute @e[name=choco_genIceTowerReece,type=armor_stand] ~ ~ ~ fill ~1 50 ~1 ~-1 100 ~-1 air 0 replace packed_ice
scoreboard players set @e[name=choco_genIceTowerReece,type=armor_stand] dyng_onGround 1 {OnGround:1b}
entitydata @e[name=choco_genIceTowerReece,type=armor_stand,score_dyng_onGround_min=1] {CustomName:"choco_genIceTower",NoGravity:1,Tags:["dyno_trigger_a","dyno_spx"]}
...
execute @e[name=ChunkCheck,type=armor_stand,score_dyn_spawn_min=1,score_dyn_gen_min=1,score_dyn_gen=1,score_dyng_checkvar_min=1] ~ ~ ~ detect ~ 0 ~ cobblestone 0 execute @s ~ ~ ~ detect ~ 75 ~ stained_hardened_clay -1 summon armor_stand ~ 110 ~ {CustomName:"robert_genMesaTempleReece",Invisible:1,Invulnerable:1,Tags:["dyno_trigger_a"]}
execute @e[name=robert_genMesaTempleReece,type=armor_stand] ~ ~ ~ fill ~6 80 ~6 ~-6 110 ~-6 air 0 replace leaves
execute @e[name=robert_genMesaTempleReece,type=armor_stand] ~ ~ ~ fill ~6 80 ~6 ~-6 110 ~-6 air 0 replace log
scoreboard players set @e[name=robert_genMesaTempleReece,type=armor_stand] dyng_onGround 1 {OnGround:1b}
entitydata @e[name=robert_genMesaTempleReece,type=armor_stand,score_dyng_onGround_min=1] {CustomName:"robert_genMesaTemple",NoGravity:1,Tags:["dyno_trigger_a","dyno_spx"]}
...
execute @e[name=ChunkCheck,type=armor_stand,score_dyn_spawn_min=1,score_dyn_gen_min=1,score_dyn_gen=1,score_dyng_checkvar_min=1] ~ ~ ~ detect ~ 0 ~ cobblestone 0 execute @s ~ ~ ~ detect ~ 30 ~ iron_ore 0 summon armor_stand ~ 80 ~ {CustomName:"robert_genSnowFortReece",Invisible:1,CustomNameVisible:0,Invulnerable:1,Tags:["dyno_trigger_a"]}
execute @e[name=robert_genSnowFortRecce,type=armor_stand] ~ ~ ~ fill ~2 ~-2 ~-17 ~20 ~-2 ~-2 snow
execute @e[name=robert_genSnowFortReece,type=armor_stand] ~ ~ ~ fill ~6 20 ~6 ~-6 110 ~-6 air 0 replace leaves
execute @e[name=robert_genSnowFortReece,type=armor_stand] ~ ~ ~ fill ~6 20 ~6 ~-6 110 ~-6 air 0 replace log
execute @e[name=robert_genSnowFortReece,type=armor_stand] ~ ~ ~ fill ~6 20 ~6 ~-6 110 ~-6 air 0 replace packed_ice
execute @e[name=robert_genSnowFortReece,type=armor_stand] ~ ~ ~ setblock ~ 30 ~ stone 0
scoreboard players set @e[name=robert_genSnowFortReece,type=armor_stand] dyng_onGround 1 {OnGround:1b}
entitydata @e[name=robert_genSnowFortReece,type=armor_stand,score_dyng_onGround_min=1] {CustomName:"robert_genSnowFort",NoGravity:1,Tags:["dyno_trigger_a","dyno_spx"]}
...
execute @e[name=ChunkCheck,type=armor_stand,score_dyn_spawn_min=1,score_dyn_gen_min=1,score_dyn_gen=1] ~ ~ ~ detect ~ 0 ~ cobblestone 0 execute @s ~ ~ ~ detect ~ 64 ~ sand 0 execute @s ~ ~ ~ detect ~ 30 ~ stone 5 summon armor_stand ~ 72 ~ {CustomName:"choco_genTentReece",Invisible:1,Invulnerable:1,Tags:["dyno_trigger_a"]}
execute @e[name=choco_genTentReece,type=armor_stand] ~ ~ ~ setblock ~ 30 ~ stone 0
execute @e[name=choco_genTentReece,type=armor_stand] ~ ~ ~ fill ~1 64 ~1 ~-1 64 ~-1 sandstone 0
scoreboard players set @e[name=choco_genTentReece,type=armor_stand] dyng_onGround 1 {OnGround:1b}
entitydata @e[name=choco_genTentReece,type=armor_stand,score_dyng_onGround_min=1] {CustomName:"choco_genTent",NoGravity:1,Tags:["dyno_trigger_a","dyno_spx"]}
