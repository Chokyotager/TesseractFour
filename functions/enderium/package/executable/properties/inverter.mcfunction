...
scoreboard players operation 1-2-3-4-5 T4_coord_x *= -1 T4_const
scoreboard players operation 1-2-3-4-5 T4_coord_z *= -1 T4_const
...
tellraw @a[r=2] {"text":"Inversion failed. The target area is not safe for you to be teleported to.","color":"red"}
