...
# THIS CODE WAS TRANSFERRED OVER FROM THE NECROMANCY MODULE ON 24 JUNE 2017 BY CHOCOPARROT
# Reason: base module should house the recipe for the incubatable egg shell instead of necromancy
