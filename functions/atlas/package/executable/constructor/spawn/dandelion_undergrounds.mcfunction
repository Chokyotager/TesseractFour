...
execute @s[score_T4_A_stats_min=7,score_T4_A_stats=7] ~ ~ ~ summon armor_stand ~ 150 ~ {Tags:["T4_A_g_brm","T4_A_fall","T4_A_clear"],CustomName:"Atlas Generation",Invisible:1,Marker:1,Invulnerable:1,Motion:[0.0d,-10.0d,0.0d]}
